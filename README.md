...
3. **Copy `templates/annual-plan.md` into `log/` and fill it out** (e.g.
   `log/2026-plan.md`). This is where the decade-scale phases become concrete.
4. **Log weekly, review annually.** The weekly log is deliberately tiny so you
   actually do it. The annual review is where you correct course.
5. **Revise the phase documents every few years.** They are forecasts, not
