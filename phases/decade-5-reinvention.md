...
## Years 44–46: Transmission at scale, and formal re-entry

**Themes**

- **Unshared mastery doesn't compound; it retires.** Decade 4 built the
  institution; this is where you staff it, hand it over, and let it be
  changed by people who aren't you. Name specific successors — not "juniors,"
  particular people — and give them the work while you can still help.
- Write the book-length synthesis if it isn't written. The full-scale account
...
- [ ] The synthesis work finished and out.
- [ ] Two named successors carrying work you started, with authority to
      change it.
...
- **Reverse-mentoring becomes structural, not incidental.** Seniority
  ...
  Build the relationships that will: host them, ask questions in public, and
  make being contradicted visibly safe.
- Decide what stays. Closing a thirty-year line of work deliberately at a
  review is the discipline principle 7 describes. Drifting out of it is not.
...
## Running through the decade: health as escalating curriculum

Same framing as Decade 4, same evidence, more of it: exercise —
cardiovascular and resistance both, and resistance matters increasingly for
the mobility everything else depends on — sleep, social engagement, hearing
and vision correction, and continued hard learning. That last isn't decoration
on the list; sustained cognitively demanding activity is among the
better-supported protective factors, which makes this agenda part of its own
regimen.
...
- **The dissipated retirement** — the most common outcome by far. The hours
  arrive, nothing was loaded, and four years later there's no artifact, no new
  field, and no account of where the time went. Allocate on paper before the
  hours land.
- **Coasting disguised as balance** — a slowdown consciously chosen is
  legitimate. Drift that was never chosen wears the same clothes. The annual
  review is where the difference gets written down, honestly.
- **The closing social world** — colleagues retire, the network thins, and
  nobody replaces them by accident. Replacement is now deliberate work:
  younger collaborators, new rooms, the class you enrolled in, the
  institution you built.
- **Deferring the third spike** — "I'll start that later." This decade *is*
  later. It has been later since year 41.
